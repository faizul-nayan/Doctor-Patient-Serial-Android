...
public class DashboadPatientAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public DashboadPatientAdapter(Context context, DrDashboardPresenter.View view) {
