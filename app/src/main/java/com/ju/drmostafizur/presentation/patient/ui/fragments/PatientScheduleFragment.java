 ...
 */
public class PatientScheduleFragment extends Fragment implements Step, PatientSchedulePresenter.View ,
        BlockingStep {

    private View view;
    private static  PatientScheduleFragment mInstance;
    ...
    public static PatientScheduleFragment getInstance() {
        mInstance = new PatientScheduleFragment();
        return mInstance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_patient_schedule, null);
    ...
    private void init(){
        ...
        patientBookedModel = new PatientBookedModel();
        ...
        String selectedDay = calendar.getDisplayName(Calendar.DAY_OF_WEEK,Calendar.LONG, Locale.getDefault());
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        String selectedDate = format.format(calendar.getTime());


        patientBookedModel.setDay(selectedDay);
        patientBookedModel.setDate(selectedDate);
    ...
    public void onScheduleFound(List<DrSchedule> drSchedule, int serial) {
        ...
        if(drSchedule.size() > 0){
            ...
            serialTv.setText("Serial: "+serial);
        }
        else {
